...
- [Runner event egress](runner-event-redaction.md) redacts the known plaintext lease and explicit credential fields before transmission, verified with actual commands/HTTP/SSE/database/browser use. This does not complete general secret scanning or protection for direct API writes, artifacts, crash dumps and cloud-init.
