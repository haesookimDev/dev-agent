...
[Work-scoped ordinary artifact writes/reads](artifact-isolation.md), [executable-document rejection with download content revalidation](artifact-content.md), and [international filenames/retained-header safety](artifact-filenames.md) were added (2026-09-06). Retained out-of-scope keys, descendant links and unsupported MIME are not served. HTTP cache protection, artifact-viewer contrast/error guidance and physical file backup/restore remain separate follow-up work.
