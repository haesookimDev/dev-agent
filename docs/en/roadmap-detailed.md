...
[Work-scoped ordinary artifact writes/reads](artifact-isolation.md) and [executable-document rejection with download content revalidation](artifact-content.md) were added (2026-09-06). Retained out-of-scope keys, descendant links and unsupported MIME are not served. Filename encoding/HTTP cache protection, artifact-viewer contrast/error guidance and physical file backup/restore remain separate follow-up work.
