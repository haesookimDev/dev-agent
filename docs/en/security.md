...
Before enabling repository writes in production, add environment-level integration tests proving that a prompt-injected issue cannot obtain a write token, approve a run, address another lease, or modify a protected branch.
