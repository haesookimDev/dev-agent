...
2. **Partially complete:** OIDC authentication, organization/repository authorization and [append-only feedback audits](feedback-audit.md) are implemented. Console/approval/cancellation/delivery audits and OIDC preview grants remain.
