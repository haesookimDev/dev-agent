...
2. **Partially complete:** OIDC authentication, organization/repository authorization and append-only [feedback](feedback-audit.md), [console/approval](control-action-audit.md), and [unassigned queued cancellation](work-cancellation.md) audits are implemented. Active-run administrator cancellation, delivery auditing, and OIDC preview grants remain.
