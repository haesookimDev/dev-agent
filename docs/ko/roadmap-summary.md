...
2. **부분 완료:** OIDC 인증과 조직·저장소 권한, [피드백](feedback-audit.md)과 [Console·승인](control-action-audit.md)의 추가 전용 감사, [세션·작업 범위 HTTP Preview Grant](preview-access.md)를 추가했습니다. 취소·전달 감사는 남아 있습니다. Preview의 실제 공개 DNS·기업 IdP·VM Network 검증은 별도 Release 조건입니다.
