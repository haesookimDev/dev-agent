...
2026-09-13 [네트워크 PR #62의 CI](https://github.com/haesookimDev/dev-agent/actions/runs/34712642565)에서 기존 백업 대상 링크의 접근 시간 변경이 발견됐습니다. 병합을 멈추고 동기화한 기준 `294dbbb7c633d1cfe999e649d97f99487115c828`에서 별도 수정 `dd35a8e26c9cf4953984015c344a6d6827860d14`를 만들었습니다. [백업 검증](artifact-backup.md)은 회귀의 수정 전 실패, API 1196 통과/153 조건부 Skip, 정적 검사와 실제 Mac CLI의 정상/기존 대상 거부·원본 보존을 기록합니다. 수정 PR의 최종 CI·병합 후 #62에 통합하고 최신 검사를 다시 확인합니다. 이 선행 회귀 수정으로 남은 실행기·네트워크·GUI·동시 작업 조건이나 1/7(14.3%)은 바뀌지 않습니다.
