...
9. 네트워크 수명주기 [PR #62](https://github.com/haesookimDev/dev-agent/pull/62)는 최종 Head `ff6036c0c1d9318db21eea25768cb400c194aad2`의 [CI 5개](https://github.com/haesookimDev/dev-agent/actions/runs/34713928147)가 첫 실행 6분 6초에 통과했고 실제 검증·리뷰 확인 후 `2b7e76d84ea56416c39f00dde1ee2bfa298f3b27`로 병합됐습니다. 후속 NIC 소스 `fdd2e08b0f21447f7d9b32cec063c82ce5d69a84`는 새 ARM64 이미지에서 [실제 양방향 패킷 차단](worker-network-packets.md)을 1개/79.80초에 다시 통과했습니다. Loopback 대조군, 방향별 12개 프레임과 DROP 5→17/6→18, 새 정리 경계와 VM/Network/Disk 제거, 원본 이미지 해시·소유자·0600 ACL 및 상위 경로 권한 복원을 확인했습니다. 이전 소스 `071f95f7c96ec16bbf965cf4fcb3b6048122923f`의 109.96초 기록과 구분합니다. 운영 Executor·Runner·허용 송신·동시 두 VM 검증은 아닙니다. NIC PR #63의 최종 CI·리뷰·병합 상태는 PR에 기록하며, 이 기능의 검증과 전체 출시 조건을 구분합니다. 완료율은 1/7(14.3%) 그대로입니다.
