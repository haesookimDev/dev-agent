...
상태: 인증 Batch(2026-09-04)와 조직·저장소 RBAC Batch(2026-09-05) 구현 완료. 등록된 Membership과 저장소별 Role 승격, 조직 간 접근 차단, GitHub 설치 등록과 Slack Principal 연결, 권한 회수를 포함합니다. [피드백 감사](feedback-audit.md), [Console·승인 감사](control-action-audit.md), [OIDC HTTP Preview Grant](preview-access.md)(2026-09-06)를 구현했습니다. 취소·전달 감사와 실제 배포 환경 Preview 검증은 남아 있습니다.
